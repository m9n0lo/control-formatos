                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-4 mt-3">
                            ...
                            <div class="form-floating">
                                <select class="js-example-basic-single" class="form-control" name="persona_id"
                                    id="persona_id" required>
                                    <option value="" disabled selected>-- Seleccione un Funcionario--</option>
                                    @foreach ($person as $pe)
                                        <option value="{{ $pe->id }}">{{ $pe->nombre_funcionario }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-4 mt-3">
                            <!-- Email input -->
                            <div class="form-floating">
                                <input type="date" name="fecha_mant_est" class="form-control" id="fecha_mant_est"
                                    required />
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-4 mt-3">
                            <!-- Name input -->
                            <div class="form-floating">
                                <input type="date" name="fecha_retiro" class="form-control" id="fecha_retiro" required />
                        ...
                        <form method="post" id="sample_form" class="form-horizontal">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_equipo_m" id="nombre_equipo_m"
                                        class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label>Fecha Mantenimiento Estipulada : </label>
                                    <input type="date" name="fecha_mant_est_m" id="fecha_mant_est_m"
                                        class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label>Fecha Retiro : </label>
                                    <input type="date" name="fecha_retiro_m" id="fecha_retiro_m"
                                        class="form-control" />
                                </div>
                                <div class="form-group editpass">
                                    <label>Fecha Entrega: </label>
                                    <input type="date" name="fecha_entrega_m" id="fecha_entrega_m"
                                        class="form-control" />
                                </div>
                                <div class="form-group editpass">
                                    <label>Observaciones: </label>
                                    <input type="textarea" name="observaciones_m" id="observaciones_m"
                                        class="form-control" />
                                </div>
